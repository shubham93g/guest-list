...
export const wedding = {
  ...
  venueMapUrl: 'https://maps.app.goo.gl/QKoW6gL6dRsUUrHy9', // short link takes priority over venueAddress for Maps
  ...
  durationHours: 4, // used for Google Calendar link and .ics end time
};
